...
![hydra admin](linux-attacksassets/image-20230319171607544.png)
...
![](linux-attacksassets/image-20230319172449606.png)

```bash
enum4linux -a -u admin -p password1 192.34.128.3
```

![enum4linux part of response](linux-attacksassets/image-20230319172756465.png)
