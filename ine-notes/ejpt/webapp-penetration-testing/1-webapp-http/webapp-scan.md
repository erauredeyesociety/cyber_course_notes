...
![](1-webapp-httpassets/image-20230504161231898.png)

- Login to the web app with `bee`:`bug` credentials
  - set the security level to `low`

![](1-webapp-httpassets/image-20230504173337687.png)
...
![](1-webapp-httpassets/image-20230504162052925.png)

![](1-webapp-httpassets/image-20230504162245625.png)

![](1-webapp-httpassets/image-20230504162342918.png)

- Enable `Forced User mode`

![](1-webapp-httpassets/image-20230504162512403.png)

- `Include in Context` the Site `https://192.192.29.3/` and confirm with **`OK`**

![](1-webapp-httpassets/image-20230504162721398.png)

- Run a **`Spider`** attack on the site, select the `bee` user and Start the scan

![](1-webapp-httpassets/image-20230504162803069.png)

![196 URLs Found](1-webapp-httpassets/image-20230504162912742.png)

- Run an **`Active Scan`** on the site, select the `bee` user and Start the scan

![](1-webapp-httpassets/image-20230504163034249.png)

- In the `Alerts` tab check the 🚩`High` risk Alerts

![](1-webapp-httpassets/image-20230504172932311.png)
...
![](1-webapp-httpassets/image-20230504173742160.png)

![](1-webapp-httpassets/image-20230504173751062.png)

- Using the `ZAP HUD`, Site Alerts can be accessed. Every vulnerability is clickable and can be directly tried via the URL

![](1-webapp-httpassets/image-20230504174218018.png)

![](1-webapp-httpassets/image-20230504174327973.png)

![](1-webapp-httpassets/image-20230504174441116.png)
...
![](1-webapp-httpassets/image-20230504175036074.png)
...
![nikto](1-webapp-httpassets/image-20230504182151396.png)
...
![IDOR - LFI](1-webapp-httpassets/image-20230504182309267.png)

```
firefox nikto.html
```

![](1-webapp-httpassets/image-20230504183330574.png)

![LFI](1-webapp-httpassets/image-20230504183356515.png)
...
![](1-webapp-httpassets/image-20230504183457260.png)
