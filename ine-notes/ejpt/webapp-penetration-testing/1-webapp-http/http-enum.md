...
![](1-webapp-httpassets/image-20230503193434893.png)
...
![dirb http://192.41.48.3](1-webapp-httpassets/image-20230503193742374.png)
...
![](1-webapp-httpassets/image-20230503194859978.png)
...
![POST](1-webapp-httpassets/image-20230503195235445.png)
...
![](1-webapp-httpassets/image-20230503195647655.png)
...
![http://192.41.48.3/uploads/hello.txt](1-webapp-httpassets/image-20230503195951821.png)
...
![](1-webapp-httpassets/image-20230504132553928.png)

![](1-webapp-httpassets/image-20230504132902967.png)
...
![](1-webapp-httpassets/image-20230504133444982.png)

- Try to upload a file to `/uploads/`

![](1-webapp-httpassets/image-20230504133626514.png)

![](1-webapp-httpassets/image-20230504133907192.png)
...
![](1-webapp-httpassets/image-20230504135323480.png)
...
![gobuster](1-webapp-httpassets/image-20230504135749412.png)
...
![](1-webapp-httpassets/image-20230504140051930.png)

```bash
gobuster dir -u http://192.185.38.3/data -w /usr/share/wordlists/dirb/common.txt -b 403,404 -x .php,.xml,.txt -r
```

![](1-webapp-httpassets/image-20230504140129200.png)

- Check the `xml` file
  - `http://192.185.38.3/data/accounts.xml`

![accounts.xml](1-webapp-httpassets/image-20230504140341853.png)
...
![](1-webapp-httpassets/image-20230504141116943.png)

![](1-webapp-httpassets/image-20230504141534109.png)

![](1-webapp-httpassets/image-20230504141924267.png)

![](1-webapp-httpassets/image-20230504142015220.png)

- Navigate to `http://192.221.162.3/passwords/accounts.txt`

![](1-webapp-httpassets/image-20230504142127386.png)
